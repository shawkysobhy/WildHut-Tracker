...
export async function getBookings({ filter, sortBy, page }) {
	// const { data, error } = await supabase.from('bookings').select('id,created_at,startDate,endDate,nightsNum,guestNum,status,totalPrice,cabins(name),guests(fullName,email)');
	let query = supabase
		.from('bookings')
		.select(
